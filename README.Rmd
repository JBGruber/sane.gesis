...
The resulting vector can be sent to the person who manages the offline machine and can add files.
They can then build a portable repository using `build_portable_repo()`:
