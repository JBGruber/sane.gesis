...
If you want to install packages globally for all users, you can do so by
specifying the global library path (as a Windows admin user):

``` r
install_portable_repo(lib = "C:/R/library")
```
